...
import com.raghav.launches.util.FakeLaunchesRepository
import com.raghav.launches.util.FakeReminderScheduler
import com.raghav.launches.util.MainDispatcherRule
import com.raghav.launches.util.launchDetailDtoString
import com.raghav.launches.util.launchesResponseDtoString
...
class LaunchesScreenVMTest {
    ...
    UiState = LaunchesScreenState(
       val launches: ImmutableList<LaunchDetail> ,
    ...
    fun getLaunches_eventSuccessful_updatesUiState() = runTest {
        ...
        val expected =
            LaunchesScreenState(launches = launches.toImmutableList())
